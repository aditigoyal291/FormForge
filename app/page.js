...
const page = () => {
	return (
		<>
			<div className="py-4 outline flex flex-col mx-auto min-h-screen">
				<Navbar />
				<div className="flex-1 h-full text-white flex items-center justify-center flex-col gap-5 mt-20">
					...
					<div className="flex-1 h-full my-auto">
						...
						<p className="text-foreground-muted/80 text-base sm:text-lg md:text-xl my-3 text-center m-3 ">
