...
const SubHero = ({ title, subtitle, children }) => {
  return (
    <div className="mx-auto relative gap-y-2 flex max-w-xl flex-col justify-center items-center">
      ...
      <h1 className="text-clamp capitalize text-center font-black bg-gradient-to-r from-primary via-secondary/80 to-secondary text-transparent bg-clip-text animate-gradient">
        {title}
      </h1>
